...
const baseButtonClasses =
  'relative flex items-center justify-center gap-2 rounded-md font-medium focus:outline-none focus:ring-2 transition-colors duration-200 disabled:cursor-not-allowed cursor-pointer';
...
<template>
  ...
  >
    ...
    <span
      ...
      :class="props.loading ? 'opacity-100' : 'opacity-0 pointer-events-none'"
    >
      <SvgLoader name="spinner" class="animate-spin" />
    </span>
  </button>
</template>
